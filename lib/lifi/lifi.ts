import { convertQuoteToRoute, executeRoute, getQuote, QuoteRequest, Route } from "@lifi/sdk";
import { base } from "viem/chains";
import { USDC_BASE_ADDRESS } from "../const";
...
export async function getRoutesResult(address: string, fromChainId: number, fromTokenAddress: string, fromAmount: string) {
